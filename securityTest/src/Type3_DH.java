 ...
 *
 */
public class Type3_DH  extends HMAC{
	public static final String ALGORITHM = "DH";   
	/**   
	 * 默认密钥字节数  
	 * <pre> DH   Default Keysize 1024
	 * Keysize must be a multiple of 64, ranging from 512 to 1024 (in clusive).  
	 * </pre>*/  
	private static final int KEY_SIZE = 1024;
	/**
	 * DH加密下需要一种对称加密算法对数据加密，这里我们使用DES，也可以使用其他对 称加密算法
	 * */    
