...
import com.ultrapower.mcs.engine.video.VideoCaptureDeviceInfoAndroid.FrontFacingCameraType;
		...
		// Populate the deviceList with available cameras and their capabilities.
				...
				try {
					if (android.os.Build.VERSION.SDK_INT > 8) {
						...
						Integer num = (Integer) getNumberOfCamerasMethod.invoke(cameraClazz, null);
