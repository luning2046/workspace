...
private DemoApi mDemoApi;//============处理http请求的入口类===========================================
...
private User currentUser;//======================登录用户信息=======================================
private ArrayList<UserInfo> mUserInfos;//==================登录用户成功的好友信息=================================
...
//        location.mkdirs();
    ...
    public void setFriends(ArrayList<UserInfo> userInfos) {
         ...
         *===============将好友列表信息放入RongIM中又在RongIM放入到RCloudContext的类中=======最终显示好友列表FriendMultiChoiceFragment就是在RCloudContext中取得的============================
         */
