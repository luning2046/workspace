...
public class Utils {
	...
	public static byte[] intToBytes(int in) {
		...
		b[0] = (byte) (0xff & in);
		b[1] = (byte) ((0xff00 & in) >> 8);
		b[2] = (byte) ((0xff0000 & in) >> 16);
		b[3] = (byte) ((0xff000000 & in) >> 24);
		return b;
	}
	...
	public static String getUserAgent(Context context) {
		...
		return String.format("%s/%s; %s/%s/%s/%s; %s/%s/%s", packageInfo.packageName, packageInfo.versionName, Build.BRAND, Build.DEVICE, Build.MODEL,
				Build.ID, Build.VERSION.SDK_INT, Build.VERSION.RELEASE, Build.VERSION.INCREMENTAL);
	}
