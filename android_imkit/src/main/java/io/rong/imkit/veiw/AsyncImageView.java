...
public class AsyncImageView extends CacheableImageView implements Observer {
    ...
    public AsyncImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, ResourceUtils.getStyleablesResourceId(context, "AsyncImageView"));

        int resId = a.getResourceId(ResourceUtils.getStyleableResourceId(context, "AsyncImageView_defDrawable"), 0);
